                                ...
                                <div class="product-select-box">
                                    <div class="product-short">
                                        ...
                                        <select class="nice-select" id = "select" onchange="sort()" >
                                            ...
                                            <option value="<?php echo stripVN10($result->name);?>/sortAZ/<?php echo $id; ?>">A-Z</option>
                                            <option value="<?php echo stripVN10($result->name);?>/sortZA/<?php echo $id; ?>">Z-A</option>
                                            
                                            <option value="<?php echo stripVN10($result->name);?>/sortLH/<?php echo $id; ?>">Giá tăng dần</option>
                                            <option selected value="<?php echo stripVN10($result->name);?>/sortHL/<?php echo $id; ?>">Giá giảm dần</option>
                                        </select>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-6 mt-40">
                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="<?php echo stripVN10($rows->category_name).'/'.stripVN10($rows->name).'/'.$rows->id; ?>">
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="<?php echo stripVN10($rows->category_name).'/'.stripVN10($rows->name).'/'.$rows->id; ?> ?>"><?php echo $rows->name;?></a></h4>
                                                                <div class="price-box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <ul class="pagination-box">
                                                    ...
                                                    <?php if(isset($_GET["p"])&&$_GET["p"]!=1): ?><li><a href="<?php echo stripVN10($result->name); ?>/<?php echo $id; ?>/sortHL/page/<?php echo isset($_GET["p"])&& $_GET["p"]>1?$_GET["p"]-1:$num_page;?>" class="Previous"><i class="fa fa-chevron-left"></i> Trước </a>
                                                    </li><?php endif; ?>
                                                    <?php for($i=1;$i<=$num_page;$i++):?>
                                                    <li <?php if(isset($_GET["p"])&&$_GET["p"]==$i) echo "class=\"active\""; ?>><a href="<?php echo stripVN10($result->name); ?>/<?php echo $id; ?>/sortHL/page/<?php echo $i;?>"><?php echo $i;?></a></li>
                                                    <?php endfor;?>
                                                    <?php if(isset($_GET["p"])&&$_GET["p"]!=$num_page): ?><li>
                                                      <a href="<?php echo stripVN10($result->name); ?>/<?php echo $id ?>/sortHL/page/<?php echo isset($_GET["p"])&& $_GET["p"]<$num_page?$_GET["p"]+1:1;?>" class="Next"> Sau <i class="fa fa-chevron-right"></i></a>
                                                    </li><?php endif; ?>
                                                </ul>
                                            </div>
                                        </div>
