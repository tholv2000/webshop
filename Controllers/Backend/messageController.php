<?php 
	...
	include "Models/Backend/messageModel.php";
	class messageController extends baseController{
		...
		public function listMessages(){
			...
			$this->setView("Views/Backend/message.php", array("list_record"=>$list_record,"num_page"=>$num_page));
			//hien thi noi dung len man hinh
			$this->renderBody();
		}
		public function delete(){
			$this->executeDelete();
			header("location:index.php?area=admin&controller=message&action=listMessages");
		}
	}
?>