<?php 
	//load file newsModel.php de co the ke thua duoc class newsModel trong file do
	include "Models/Backend/newsModel.php";
	class newsController extends baseController{
		//ke thua class newsModel de goi cac ham trong class do tu newsController (la cac ham thao tac csdl)
		use newsModel;
		...
		public function listNews(){
			...
			$this->setView("Views/Backend/news.php", array("list_record"=>$list_record,"num_page"=>$num_page));
		...
		public function edit(){
			...
			$record = $this->fetchOne(); //ham trong class NewsModel
			//tao bien $form_action de dieu phoi action cua form
			$form_action = "index.php?area=admin&controller=news&action=doEdit&id=$id";
			//set file view
			$this->setView("Views/Backend/add_edit_news.php",array("record"=>$record,"form_action"=>$form_action));
			//set layout
		...
		public function doEdit(){
			$this->executeEdit(); //ham nay trong class newsModel
			//quay tro lai trang user
			header("location:index.php?area=admin&controller=news&action=listNews");
		}
		//add user
		public function add(){
			$form_action="index.php?area=admin&controller=news&action=doAdd";
			//set duong dan cua file tempate
			$this->setLayout("Views/Backend/layout_menu_ngang.php");
			//day noi dung MVC vao bien view (muon truyen bien nao ra view thi dua vao danh sach array)
			/*
			...
			*/
			$this->setView("Views/Backend/add_edit_news.php",array("form_action"=>$form_action));
			//hien thi noi dung len man hinh
			$this->renderBody();
		}
		//do edit user
